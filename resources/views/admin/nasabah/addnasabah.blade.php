                    ...
                    <form action="{{ route('storenasabah') }}" method="post">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="namanasabah"
                                value="{{ old('namanasabah') }}" class="form-control @error('namanasabah') is-invalid @enderror" id="nama" placeholder="">
                            @error('namanasabah')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="teleponnasabah"
                                value="{{ old('teleponnasabah') }}" class="form-control @error('teleponnasabah') is-invalid @enderror" id="nama" placeholder="">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="alamatnasabah"
                                value="{{ old('alamatnasabah') }}" class="form-control @error('alamatnasabah') is-invalid @enderror" id="nama" placeholder="">
                            @error('alamatnasabah')
                                <div class="invalid-feedback">
